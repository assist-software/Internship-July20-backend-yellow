...
from api.permissions import AdminPermission, CoachPermission, AthletePermission, AdminANDCoachPermission, AllPermission
...
def athlete(request):
    ...
    if request.method == "POST":
        ...
        newuser = User.objects.create_user(email=email, first_name=name[0], last_name=name[1],
        ...
        message = ('Hello {}!\n'
                   ...
                   'email : {}\n'
                   'password : {}\n'
                   'Club Management team.').format(newuser.get_full_name(), 'http://192.168.149.50:8001/api/signin/',
                                                   email, password)
